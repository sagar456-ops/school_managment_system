...
<body>
  <form name="myform" action="register.php" method="POST">
    ...
    <div class="container">
      ...
      <input class="reg" type="text" name="reg_no" id="reg_no" placeholder="Enter your reg no" pattern="^ACME[0-9]{4}$" required></input><br>
      <span></span>
      <label for="id"><b>Student ID</b></label>
      <input type="text" class="form-control" name="ID" id="ID" placeholder="Enter new STUDENT ID" pattern="^[0-9]{8}$" required></input>
      <span></span>
      ...
      <script type="text/javascript">
        ...
        ID.onkeyup = function() {
          ...
          if (regexoo.test(ID.value)) {
            ...
            span[1].innerText = "**Your student id is invalid it";
