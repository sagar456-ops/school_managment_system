...
<body>
      <form name="my_form" action="view_result.php" method="post">
            <div class="container">
                  ...
                  <input class="form-control-one" name="reg_no" id="reg_no" placeholder="Enter your registration number">
                  <label for="id"><b>SYMBOL NUMBER</b></label>
                  <input class="form-control-one" name="symbol_no" id="symbol_no" placeholder="Enter your symbol no number">
                  <label for="id"><b>EXAM YEAR</b></label>
                  <select class="form-control_another" name="year" id="year">
                  ...
                  <button type="submit" name="btn_submit_result" value="onsubmit">Submit</button><br>
            </div>
      </form>
